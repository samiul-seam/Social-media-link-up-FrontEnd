...
const ChatCard = ({ item, currentUserId }) => {
    const { other_user, last_message, updated_at, unread_count } = item

    // Check if there are unread messages specifically for the current user
        ...
        <View className="flex-row items-center px-4 py-3 bg-white">
            ...
            <View className="relative">
                <Image
                    ...
                    style={{ width: 55, height: 55, borderRadius: 27.5 }} // Half of width/height for perfect circle
                    contentFit="cover"
                    transition={200} // Smooth fade-in for images
                />
            ...
            <View className="flex-1 ml-3 pr-2">
                ...
                <View className="flex-row items-center justify-between mt-0.5">
                    ...
                    {/* Unread Badge - Shows actual count if available */}
                    {hasUnread && (
